...
| `public/` | Admin-Frontend (Phase 4); u. a. `design.js` (Hero-Design; Regler mit Zahlenfeld + „↺“), `background.js` (Seiten-Hintergrund: Farbe/Verlauf, Muster, Hintergrundbild, abgesetzte Sektionen, Effekte), `toolcards.js` (Tab „Tool-Karten“: Rahmen/Hintergrund der Tool-Karten je Karte, Hell/Dunkel, Sticky-Live-Vorschau), `slider.js` (gemeinsamer Regler: Slider + Zahlenfeld + „↺“), `color.js` (Farbwähler: Farbfeld + Hex + HSL-Regler; in allen Design-Tabs inkl. Layout) |
