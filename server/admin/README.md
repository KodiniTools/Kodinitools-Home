...
| `public/` | Admin-Frontend (Phase 4); u. a. `design.js` (Hero-Design), `background.js` (Seiten-Hintergrund: Farbe/Verlauf, Muster, Hintergrundbild, Effekte), `toolcards.js` (Tab „Tool-Karten“: Rahmen/Hintergrund der Tool-Karten je Karte, Hell/Dunkel, Sticky-Live-Vorschau) |
